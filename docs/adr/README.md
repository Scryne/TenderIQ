...
| [0005](0005-langgraph-orchestration.md) | Çıkarım orkestrasyonu: LangGraph | Kabul edildi |
| [0008](0008-bge-m3-embedding.md) | Embedding: BGE-M3 (OSS) + yönetilen geçiş opsiyonu | Kabul edildi |
...
| [0012](0012-hybrid-retrieval-rerank.md) | Hibrit getirim: pgvector + BM25 + RRF + reranker | Kabul edildi |

> Sonraki set (ilgili fazlarda): 0006 zorunlu grounding, 0007 zero-retention LLM.
> Bkz. Geliştirme Planı §G.
